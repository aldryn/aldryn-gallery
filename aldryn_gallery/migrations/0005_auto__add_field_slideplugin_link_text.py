...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SlidePlugin.link_text'
        db.add_column(u'aldryn_gallery_slideplugin', 'link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SlidePlugin.link_text'
        db.delete_column(u'aldryn_gallery_slideplugin', 'link_text')
