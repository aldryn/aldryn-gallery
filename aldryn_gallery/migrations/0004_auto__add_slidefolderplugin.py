...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SlideFolderPlugin'
        db.create_table(u'aldryn_gallery_slidefolderplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'])),
        ))
        db.send_create_signal(u'aldryn_gallery', ['SlideFolderPlugin'])


    def backwards(self, orm):
        # Deleting model 'SlideFolderPlugin'
        db.delete_table(u'aldryn_gallery_slidefolderplugin')
