...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryPlugin.extra_styles'
        db.add_column(u'aldryn_gallery_galleryplugin', 'extra_styles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryPlugin.extra_styles'
        db.delete_column(u'aldryn_gallery_galleryplugin', 'extra_styles')
    ...
    models = {
        u'aldryn_gallery.galleryplugin': {
            ...
            'extra_styles': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        u'aldryn_gallery.slidefolderplugin': {
            'Meta': {'object_name': 'SlideFolderPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
